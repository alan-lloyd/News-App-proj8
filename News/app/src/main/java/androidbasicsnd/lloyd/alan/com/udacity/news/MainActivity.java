...
public class MainActivity extends AppCompatActivity implements LoaderCallbacks<List<News>> {
    ...
    //Constant value for the News loader ID. Can choose any integer
    private static final int NEWS_LOADER_ID = 1;
    // Tag for log messages
    private static final String LOG_TAG = NewsLoader.class.getName();
    //   string  to obtain unrefined news data from the Guardian newspaper API;
    private static final String NEWS_REQUEST_URL =
            "https://content.guardianapis.com/search?q=business&AND&trade&from-date=2017-08-01&tags=order-by-Date&show-tags=contributor&api-key=75700ee6-e4a9-4f2c-b53e-2cb294199581";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //listener to load user selected web pages from news items
